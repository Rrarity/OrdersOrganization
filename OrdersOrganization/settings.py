# Django settings for OrdersOrganization project.
...
SECRET_KEY = '8a%#nrfl)h=ig52(yfec)gj6#236y@!sl&0b$cg=#v@n&thphp'
...
MIDDLEWARE_CLASSES = (
    ...
    'MyOrders.middleware.MiddleWareProcess',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'OrdersOrganization.urls'
